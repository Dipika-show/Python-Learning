#write a program to find the greatest  from four numbers entered by the user
a1=int(input("Enter your number1:"))
a2=int(input("Enter your number1:"))
a3=int(input("Enter your number1:"))
a4=int(input("Enter your number1:"))
